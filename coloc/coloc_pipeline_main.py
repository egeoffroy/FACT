...
if args.meqtl:
    os.system('Rscript make_coloc_files.R ' + gwasSS + ' ' + frqfile + ' ' + phenoid + ' ' + result + ' ' + pop + ' ' + str(populations.get(pop)) + ' ' + args.meqtl) #currently only for MESA models
else:
    os.system('Rscript make_coloc_files.R ' + gwasSS + ' ' + frqfile + ' ' + phenoid + ' ' + result + ' ' + pop + ' ' + str(populations.get(pop))) #currently only for MESA models




os.system('bash run_coloc.sh ' + pop + ' ' + phenoid + ' ' + str(populations.get(pop)))
